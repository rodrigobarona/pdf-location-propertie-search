...
import { LocationDocument } from "../types/typesense";
...
const LocationHitComponent = ({ 
  ...
  const levelLabel = ["Country", "Region", "District", "Municipality"][level] || `Level ${level}`;
...
export default function LocationSearch({ onLocationSelect }: LocationSearchProps) {
  return (
    <div className="bg-white rounded-lg shadow p-4">
      <h2 className="text-xl font-semibold mb-4">Search Administrative Regions</h2>
      ...
      <div className="mb-4">
        <SearchBox 
          ...
          classNames={{
            root: "relative",
            form: "relative",
            input: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent",
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="md:col-span-1">
          ...
          <RefinementList
            ...
            classNames={{
              ...
              checkbox: "mr-2 h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500",
              count: "ml-2 text-xs text-gray-500 rounded-full bg-gray-100 px-2 py-0.5",
            }}
        ...
        <div className="md:col-span-3">
          <EmptyQueryBoundary>
            <Hits
              hitComponent={({ hit }) => (
                <LocationHitComponent hit={hit as unknown as LocationDocument} onSelect={onLocationSelect} />
              )}
              classNames={{
